...
\item MD5 authentication: type 2 -> use of MD5 cryptographic passwords (also not secure anymore!)
\end{itemize}
...
The main disadvantage of plain text authentication is, that the password can be clearly seen in the packet.
